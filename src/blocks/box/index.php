...
add_filter(
	'render_block_snow-monkey-blocks/box',
	function ( $content ) {
		...
		$p2->next_tag( array( 'class_name' => 'smb-box__body' ) );
		...
		$p1->remove_class( 'wp-block-box-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-box__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-box-is-layout-constrained' );
