...
add_filter(
	'render_block_snow-monkey-blocks/panels-item-block-link',
	function ( $content ) {
		...
		$p1->remove_class( 'wp-block-panels-item-block-link-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-panels__item__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-panels-item-block-link-is-layout-constrained' );
