...
add_filter(
	'render_block_snow-monkey-blocks/information-item',
	function ( $content ) {
		...
		$p2->next_tag( array( 'class_name' => 'smb-information__item__body' ) );
		...
		$p1->remove_class( 'wp-block-information-item-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-information__item__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-information-item-is-layout-constrained' );
