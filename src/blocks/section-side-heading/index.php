...
add_filter(
	'render_block_snow-monkey-blocks/section-side-heading',
	function ( $content ) {
		...
		$p1->remove_class( 'wp-block-section-side-heading-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-section__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-section-side-heading-is-layout-constrained' );
