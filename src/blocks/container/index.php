...
add_filter(
	'render_block_snow-monkey-blocks/container',
	function ( $content ) {
		...
		$p2->next_tag( array( 'class_name' => 'smb-container__body' ) );
		...
		$p1->remove_class( 'wp-block-container-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-container__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-container-is-layout-constrained' );
