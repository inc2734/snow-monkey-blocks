...
add_filter(
	'render_block_snow-monkey-blocks/balloon',
	function ( $content ) {
		...
		$p2->next_tag( array( 'class_name' => 'smb-balloon__body' ) );
		...
		$p1->remove_class( 'wp-block-balloon-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-balloon__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-balloon-is-layout-constrained' );
