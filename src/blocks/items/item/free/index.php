...
add_filter(
	'render_block_snow-monkey-blocks/items-item-free',
	function ( $content ) {
		...
		$p2->next_tag( array( 'class_name' => 'smb-items__item__body' ) );
		...
		$p1->remove_class( 'wp-block-items-item-free-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-items__item__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-items-item-free-is-layout-constrained' );
