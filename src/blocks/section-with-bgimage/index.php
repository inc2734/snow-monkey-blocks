...
wp_enqueue_block_style(
	...
	array(
		'handle' => generate_block_asset_handle( 'snow-monkey-blocks/section-with-bgimage', 'style' ),
		'src'    => SNOW_MONKEY_BLOCKS_DIR_URL . '/dist/blocks/section-with-bgimage/style-index.css',
...
add_filter(
	...
	function ( $content ) {
		...
		$p1->remove_class( 'wp-block-section-with-bgimage-is-layout-constrained' );
		$p1->next_tag( array( 'class_name' => 'smb-section__body' ) );
		$p1->add_class( 'is-layout-constrained' );
		$p1->add_class( 'wp-block-section-with-bgimage-is-layout-constrained' );
