...
<!-- wp:snow-monkey-blocks/section {"backgroundColor":"var(--_lightest-color-gray)","align":"full"} -->
<div class="wp-block-snow-monkey-blocks-section alignfull smb-section smb-section--fit" style="--smb-section--background-color:var(--_lightest-color-gray)">
				...
				<div class="smb-section__body">
					...
					<div class="wp-block-snow-monkey-blocks-items smb-items">
						<div class="c-row c-row--margin" data-columns="1" data-md-columns="1" data-lg-columns="2">
							<!-- wp:snow-monkey-blocks/items-banner {"maskOpacity":0.7,"imageSize":"wide"} -->
							<div class="wp-block-snow-monkey-blocks-items-banner c-row__col">
								<div class="smb-items__banner smb-items__banner--wide" style="--smb-items--banner--mask-opacity:0.7">
									<div class="smb-items__banner__figure">
										<div class="smb-items__banner__figure__mask"></div>
										<img src="<?php echo esc_url( SNOW_MONKEY_BLOCKS_DIR_URL ); ?>/dist/img/photos/0023_xlarge.jpg" alt="" class="wp-image-0"/>
									</div>
									<div class="smb-items__banner__body" data-content-position="center-left">
							...
							<div class="wp-block-snow-monkey-blocks-items-banner c-row__col">
								<div class="smb-items__banner smb-items__banner--wide" style="--smb-items--banner--mask-opacity:0.7">
									<div class="smb-items__banner__figure">
										<div class="smb-items__banner__figure__mask"></div>
										<img src="<?php echo esc_url( SNOW_MONKEY_BLOCKS_DIR_URL ); ?>/dist/img/photos/0127_xlarge.jpg" alt="" class="wp-image-0"/>
									</div>
									<div class="smb-items__banner__body" data-content-position="center-left">
										<div class="smb-items__banner__body-inner">
											<div class="smb-items__banner__title">Lorem ipsum dolor sit amet</div>
