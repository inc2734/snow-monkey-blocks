		...
		migrate( attributes ) {
			const migratedInnerBlocks = () => {
				...
				return times( length, ( index ) => {
					...
					const btnLabel = get( attributes.items, [ index, 'btnLabel' ], '' );
					const btnURL = get( attributes.items, [ index, 'btnURL' ], '' );
					const btnTarget = get( attributes.items, [ index, 'btnTarget' ], '_self' );
					const btnBackgroundColor = get( attributes.items, [ index, 'btnBackgroundColor' ], '' );
					const btnTextColor = get( attributes.items, [ index, 'btnTextColor' ], '' );
