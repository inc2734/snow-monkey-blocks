	...
	<div class="smb-section__inner" style="padding-top:0;padding-bottom:0">
		<div class="c-container">
			...
			<div class="smb-section__body">
				...
				<p class="has-text-align-center" class="u-slim-width">
					...
					<div class="c-row c-row--md-nowrap">
						...
						<div class="wp-block-snow-monkey-blocks-pricing-table--item c-row__col">
							<div class="smb-pricing-table__item">
								<div class="smb-pricing-table__item__title">
									BASIC
								</div>
								<div class="smb-pricing-table__item__price">
									$5
								</div>
								<div class="smb-pricing-table__item__lede">
									/month
								</div>
								<ul>
								...
								<div class="smb-pricing-table__item__action">
									<a class="smb-pricing-table__item__btn smb-btn" href="https://example.com">
										<span class="smb-btn__label">Get Started</span>
									</a>
								</div>
							</div>
						</div>
