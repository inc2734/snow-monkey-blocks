...
<!-- wp:snow-monkey-blocks/section-with-bgimage {"titleTagName":"none","lgImageID":1,"height":"wide","maskColor":"#000000","maskOpacity":0.6,"align":"full"} -->
				...
				<div class="c-row c-row--margin c-row--middle c-row--reverse">
					...
					<div class="c-row__col c-row__col--1-1 c-row__col--lg-1-2">
						<div class="smb-media-text__figure">
							<img src="<?php echo esc_url( SNOW_MONKEY_BLOCKS_DIR_URL ); ?>/dist/img/photos/man-sitting-at-table-with-coffee-cup-using-digital-tablet.jpg" alt="" class="wp-image-1"/>
						</div>
					</div>
				</div>
			</div>
